...
docker build -t elm-ocp:${IMAGE_TAG} -f ./docker/Dockerfile .
docker login -u ${REGISTRY_USERNAME} -p ${REGISTRY_PASSWORD} ${REGISTRY_URL}
docker tag elm-ocp:${IMAGE_TAG} ${REGISTRY_URL}/elm-ocp:${IMAGE_TAG}
docker push ${REGISTRY_URL}/elm-ocp:${IMAGE_TAG}